...
This `README.md` provides an overview of the project, installation instructions, configuration steps, and how to execute the script with the correct parameters. If you need further details or additional features, feel free to adjust it as necessary!